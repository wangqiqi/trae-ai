# 🎯 .trae 快速检查清单
# 使用方法: 在PowerShell中运行 .\.trae\tools\quick-checklist.ps1
...
$checks = @(
    ...
    @{Name="系统设计"; Path="docs/architecture.md"; Icon="🏗️"},
    @{Name="开发环境"; Path="package.json"; Icon="⚙️"},
...
Write-Host "`n📊 完成度: $passed/$total" -ForegroundColor Yellow
